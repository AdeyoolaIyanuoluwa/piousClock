...
export const editMemberDetails = (payload: object, id: string) =>
  instance.put(EDIT_MEMBER_API({ id }), payload);
  
export const deleteMemberDetails = (id: string) =>
  instance.delete(DELETE_MEMBER_API({ id }));
...
export const bulkUpload = (payload: object) =>
  instance.post(BULK_UPLOAD_API, payload);
